...
#		JetJT
#-------------------------------------------------------------
JetHT_full = analyzer('trijet_nano/DataWithB_17_snapshot.txt')
JetHT_den = float(JetHT_full.DataFrame.Count().GetValue())
JetHT_full.Close()
JetHT_later = analyzer('trijet_nano/Data_17_snapshot.txt')
JetHT_num = float(JetHT_later.DataFrame.Count().GetValue())
JetHT_later.Close()
#-------------------------------------------------------------
#               SingleMuon
#-------------------------------------------------------------
SingleMuon_full = analyzer('trijet_nano/SingleMuonDataWithB_17_snapshot.txt')
SingleMuon_den = float(SingleMuon_full.DataFrame.Count().GetValue())
SingleMuon_full.Close()
SingleMuon_later = analyzer('trijet_nano/SingleMuonData_17_snapshot.txt')
