...
if ('ttbar' in args.setname):
    print('Step 0: perform gen matching to top cands')
    statuses = OrderedDict([(0,'other'), (1,'top_qq'), (2,'top_bq'), (3,'top_bqq'), (4,'Higgs'), (5,'W')])
...
#########################################################################
for iJet in range(3):
    for property in ['particleNet_mass','pt_corr','particleNetMD_WvsQCD','particleNetMD_HbbvsQCD']:
