...
for i, wp in enumerate(wps[args.era]):
    ...
    selection.a.Define(f'SubleadW_vect_WP{i}',f'hardware::TLvector(W1_WP{i}_pt_corr,W2_WP{i}_eta,W2_WP{i}_phi,W2_WP{i}_msoftdrop_corr)')
    ...
    selection.a.Define(f'SubleadW_vect_WP{i}_nocorr',f'hardware::TLvector(W1_WP{i}_pt,W2_WP{i}_eta,W2_WP{i}_phi,W2_WP{i}_msoftdrop_corr)')
