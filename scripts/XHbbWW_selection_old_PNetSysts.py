...
def selection(args):
    ...
    selection = XHYbbWW('trijet_nano/{}_{}_snapshot.txt'.format(args.setname,args.year),args.year,int(args.ijob),int(args.nchunks))
    outFileName = 'rootfiles/XHYbbWWselection_HT{}_{}_{}{}_{}of{}.root'.format(args.HT, args.setname, args.year, '_'+args.variation if args.variation != 'None' else '',args.ijob,args.nchunks)
